...
struct MemosAPIService {
    ...
    func editMemo(jwt: String?, id: Int, userId: String, color: String, content: String, isAdmin: Int, completion: @escaping ([MemoInfo])->Void) {
    ...
    func deleteMemo(jwt: String?, id: Int, userId: String, isAdmin: Int, completion: @escaping ([MemoInfo])->Void) {
